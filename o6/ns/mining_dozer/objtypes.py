...
@o6.objecttype(nodeId="ns=mining_dozer;i=1002", browseName="ns=mining_dozer;DozerType", displayName="DozerType")
class DozerType(mining.objtypes.MiningEquipmentType):
...
del Any, TYPE_CHECKING, uuid, o6, di, ia, machinery, mining, ns0, mining_dozer_datypes
