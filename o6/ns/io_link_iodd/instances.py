    ...
    references=[
        o6.hasProperty(  # WARNING: The source NodeSet value does not match the declared DataType.
            ...
            ns0.vartypes.PropertyType(
                nodeId="ns=io_link_iodd;i=6001", browseName="IsNamespaceSubset", description="If TRUE then the server only supports a subset of the namespace.", dataType=o6.Boolean
            )
        ),
        o6.hasProperty(
            ns0.vartypes.PropertyType(
