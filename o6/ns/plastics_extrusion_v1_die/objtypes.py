...
@o6.objecttype(nodeId="ns=plastics_extrusion_v1_die;i=1002", browseName="ns=plastics_extrusion_v1_die;Die_InterfaceType", displayName="Die_InterfaceType")
class Die_InterfaceType(plastics_extrusion_v1.objtypes.ExtrusionDeviceType):
