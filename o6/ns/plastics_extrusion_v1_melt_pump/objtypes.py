...
@o6.objecttype(nodeId="ns=plastics_extrusion_v1_melt_pump;i=1002", browseName="ns=plastics_extrusion_v1_melt_pump;MeltPump_InterfaceType", displayName="MeltPump_InterfaceType")
class MeltPump_InterfaceType(plastics_extrusion_v1.objtypes.ExtrusionDeviceType):
