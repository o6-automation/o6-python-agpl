...
@o6.objecttype(nodeId="ns=mining_loading;i=1002", browseName="ns=mining_loading;LoadingMachineType", displayName="LoadingMachineType")
class LoadingMachineType(mining.objtypes.MiningEquipmentType):
    defaultInstanceBrowseName: ns0.vartypes.PropertyType = o6.hasProperty(
        ns0.vartypes.PropertyType(
            nodeId="ns=mining_loading;i=6017",
            browseName="ns=mining_loading;DefaultInstanceBrowseName",
            description="The default BrowseName for instances of the type",
            dataType=o6.QualifiedName,
            value=o6.QualifiedName("mining_loading:LoadingMachine"),
        )
    )
