...
class FeederType(plastics_rubber.objtypes.DriveType):
    ...
    isPresent: ns0.vartypes.PropertyType = o6.hasProperty(
        ns0.vartypes.PropertyType(nodeId="ns=plastics_extrusion_v1_extruder;i=6004", browseName="ns=plastics_extrusion_v1_extruder;IsPresent", dataType=o6.Boolean, value=False)
    )
