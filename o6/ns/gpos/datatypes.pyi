...
class GroundControlPointDataType(ns0.datatypes.Structure):
    ...
    @property
    def globalPosition(self) -> ThreeDGeographicCoordinateDataType: ...
    @globalPosition.setter
    def globalPosition(self, value: ThreeDGeographicCoordinateDataType) -> None: ...
    @property
    def localPosition(self) -> ns0.datatypes.ThreeDCartesianCoordinates: ...
    @localPosition.setter
    def localPosition(self, value: ns0.datatypes.ThreeDCartesianCoordinates) -> None: ...
...
class GlobalLocationDataType(ns0.datatypes.Structure):
    ...
    @property
    def orientation(self) -> ns0.datatypes.ThreeDOrientation | None: ...
    @orientation.setter
    def orientation(self, value: ns0.datatypes.ThreeDOrientation | None) -> None: ...
