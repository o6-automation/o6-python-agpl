...
@o6.objecttype(nodeId="ns=plastics_extrusion_calibrator;i=1004", browseName="ns=plastics_extrusion_calibrator;Calibrator_InterfaceType", displayName="Calibrator_InterfaceType")
class Calibrator_InterfaceType(plastics_extrusion.objtypes.ExtrusionDeviceType):
...
@o6.objecttype(nodeId="ns=plastics_extrusion_calibrator;i=1003", browseName="ns=plastics_extrusion_calibrator;CalibrationZonesType", displayName="CalibrationZonesType")
class CalibrationZonesType(ns0.objtypes.BaseObjectType):
    ...
    nodeVersion: ns0.vartypes.PropertyType = o6.hasProperty(
        ns0.vartypes.PropertyType(nodeId="ns=plastics_extrusion_calibrator;i=6155", browseName="NodeVersion", dataType=o6.String)
    )
...
@o6.objecttype(nodeId="ns=plastics_extrusion_calibrator;i=1002", browseName="ns=plastics_extrusion_calibrator;CalibrationZoneType", displayName="CalibrationZoneType")
class CalibrationZoneType(ns0.objtypes.BaseObjectType):
    ...
    isPresent: ns0.vartypes.PropertyType = o6.hasProperty(
        ns0.vartypes.PropertyType(nodeId="ns=plastics_extrusion_calibrator;i=6002", browseName="ns=plastics_extrusion_calibrator;IsPresent", dataType=o6.Boolean)
    )
    name: ns0.vartypes.PropertyType = o6.hasProperty(
        ns0.vartypes.PropertyType(
            nodeId="ns=plastics_extrusion_calibrator;i=6001", browseName="ns=plastics_extrusion_calibrator;Name", dataType=o6.LocalizedText, accessLevel=3, userAccessLevel=1
        )
    )
    position: ns0.vartypes.PropertyType | None = o6.hasProperty(
        ns0.vartypes.PropertyType(nodeId="ns=plastics_extrusion_calibrator;i=6324", browseName="ns=plastics_extrusion_calibrator;Position", dataType=o6.String)
    )
