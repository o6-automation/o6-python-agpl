...
plastics_extrusion_v1_line_objtypes.ProductionParametersType(
    ...
    references=[
        ...
        o6.hasComponent(  # WARNING: The source NodeSet value does not match the declared DataType.
            # It is intentionally omitted; the server supplies a typed default.
            ns0.vartypes.BaseDataVariableType(nodeId="ns=plastics_extrusion_v1_line;i=6060", browseName="ns=plastics_extrusion_v1_line;GoodProduct", dataType=o6.Boolean)
        ),
    ],
)
...
httpColonSlashSlashOpcfoundationDotOrgSlashUASlashPlasticsRubberSlashExtrusionSlashExtrusionLineSlash = ns0.objtypes.NamespaceMetadataType(
    ...
    references=[
        o6.hasProperty(  # WARNING: The source NodeSet value does not match the declared DataType.
            # It is intentionally omitted; the server supplies a typed default.
            ns0.vartypes.PropertyType(nodeId="ns=plastics_extrusion_v1_line;i=6257", browseName="IsNamespaceSubset", dataType=o6.Boolean)
        ),
        o6.hasProperty(
            ns0.vartypes.PropertyType(
