...
class PnDeviceRoleOptionSet(ns0.datatypes.OptionSet):
    ...
    @property
    def iO_DEVICE(self) -> bool | None: ...
    @iO_DEVICE.setter
    def iO_DEVICE(self, value: bool | None) -> None: ...
    @property
    def iO_CONTROLLER(self) -> bool | None: ...
    @iO_CONTROLLER.setter
    def iO_CONTROLLER(self, value: bool | None) -> None: ...
    @property
    def iO_MULTIDEVICE(self) -> bool | None: ...
    @iO_MULTIDEVICE.setter
    def iO_MULTIDEVICE(self, value: bool | None) -> None: ...
    @property
    def iO_SUPERVISOR(self) -> bool | None: ...
    @iO_SUPERVISOR.setter
    def iO_SUPERVISOR(self, value: bool | None) -> None: ...
    @property
    def iO_CIM(self) -> bool | None: ...
    @iO_CIM.setter
    def iO_CIM(self, value: bool | None) -> None: ...
