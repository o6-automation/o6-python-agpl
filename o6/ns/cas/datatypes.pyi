...
class SensorTechnologyOptionSet(ns0.datatypes.OptionSet):
    ...
    @property
    def capacitiveSensor(self) -> bool | None: ...
    @capacitiveSensor.setter
    def capacitiveSensor(self, value: bool | None) -> None: ...
    @property
    def electronTube(self) -> bool | None: ...
    @electronTube.setter
    def electronTube(self, value: bool | None) -> None: ...
    @property
    def inductiveSensor(self) -> bool | None: ...
    @inductiveSensor.setter
    def inductiveSensor(self, value: bool | None) -> None: ...
    @property
    def ionizationSensor(self) -> bool | None: ...
    @ionizationSensor.setter
    def ionizationSensor(self, value: bool | None) -> None: ...
    @property
    def magnetometer(self) -> bool | None: ...
    @magnetometer.setter
    def magnetometer(self, value: bool | None) -> None: ...
    @property
    def opticalSensor(self) -> bool | None: ...
    @opticalSensor.setter
    def opticalSensor(self, value: bool | None) -> None: ...
    @property
    def piezoelectricSensor(self) -> bool | None: ...
    @piezoelectricSensor.setter
    def piezoelectricSensor(self, value: bool | None) -> None: ...
    @property
    def resistiveSensor(self) -> bool | None: ...
    @resistiveSensor.setter
    def resistiveSensor(self, value: bool | None) -> None: ...
    @property
    def resonantSensor(self) -> bool | None: ...
    @resonantSensor.setter
    def resonantSensor(self, value: bool | None) -> None: ...
    @property
    def temperatureSensor(self) -> bool | None: ...
    @temperatureSensor.setter
    def temperatureSensor(self, value: bool | None) -> None: ...
    @property
    def thermalSensor(self) -> bool | None: ...
    @thermalSensor.setter
    def thermalSensor(self, value: bool | None) -> None: ...
    @property
    def ultrasoundSensor(self) -> bool | None: ...
    @ultrasoundSensor.setter
    def ultrasoundSensor(self, value: bool | None) -> None: ...
