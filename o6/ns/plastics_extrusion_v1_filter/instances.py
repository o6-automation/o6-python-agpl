...
httpColonSlashSlashOpcfoundationDotOrgSlashUASlashPlasticsRubberSlashExtrusionSlashFilterSlash = ns0.objtypes.NamespaceMetadataType(
    ...
    references=[
        o6.hasProperty(  # WARNING: The source NodeSet value does not match the declared DataType.
            ...
            ns0.vartypes.PropertyType(nodeId="ns=plastics_extrusion_v1_filter;i=6172", browseName="IsNamespaceSubset", dataType=o6.Boolean)
        ),
        o6.hasProperty(
            ns0.vartypes.PropertyType(
...
plastics_rubber.objtypes.MonitoredParameterType(
    ...
    references=[
        o6.hasProperty(  # WARNING: The source NodeSet value does not match the declared DataType.
            # It is intentionally omitted; the server supplies a typed default.
            ns0.vartypes.PropertyType(
                nodeId="ns=plastics_extrusion_v1_filter;i=6023", browseName="ns=plastics_rubber;AutomaticMonitoring", dataType=o6.Boolean, accessLevel=3, userAccessLevel=1
            )
        ),
...
plastics_rubber.objtypes.MonitoredParameterType(
    ...
    references=[
        o6.hasProperty(  # WARNING: The source NodeSet value does not match the declared DataType.
            # It is intentionally omitted; the server supplies a typed default.
            ns0.vartypes.PropertyType(
                nodeId="ns=plastics_extrusion_v1_filter;i=6049", browseName="ns=plastics_rubber;AutomaticMonitoring", dataType=o6.Boolean, accessLevel=3, userAccessLevel=1
            )
        ),
...
plastics_rubber.objtypes.MeasuringDeviceType(
    ...
    references=[
        ...
        o6.hasProperty(  # WARNING: The source NodeSet value does not match the declared DataType.
            # It is intentionally omitted; the server supplies a typed default.
            ns0.vartypes.PropertyType(nodeId="ns=plastics_extrusion_v1_filter;i=6142", browseName="ns=plastics_rubber;IsPresent", dataType=o6.Boolean)
        ),
        o6.hasProperty(  # WARNING: The source NodeSet value does not match the declared DataType.
            # It is intentionally omitted; the server supplies a typed default.
            ns0.vartypes.PropertyType(
