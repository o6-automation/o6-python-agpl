...
@o6.datatype(nodeId="ns=plastics_extrusion_line;i=3003", browseName="MaterialMappingType", defaultEncodingId="ns=plastics_extrusion_line;i=5007")
class MaterialMappingType(ns0.datatypes.Structure):
    materialId: o6.String
    materialLot: o6.String
    hopperId: o6.String
