...
!!! note
    URI alone is not necessarily unique, because there may be cases in which the same nodeset in different version needs to be addressed. To disambiguate the URI string can be ammended with a scope and version number. See [Namespaces](../opcua-recap/namespace.md) for more information.
...
- OPC UA datatypes and namespace concept [Namespace](../opcua-recap/namespace.md) and how o6\\Python builds on top of it [Namespace Mapping in o6\\Python](../namespace/namespace-mapping-in-o6.md).
