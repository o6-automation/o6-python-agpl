...
- How o6 exposes and resolves namespaces from Python:
  [Address & Identity Types](../sdk-fundamentals/builtin/address-types.md),
  [Namespace Mapping in o6\\Python](../sdk-fundamentals/namespace/namespace-mapping-in-o6.md),
  [Loading & Using Nodesets](../sdk-fundamentals/namespace/loading-and-using-nodesets.md),
