...
- [Built-in types](builtin/primitive-types.md) — 25 types: primitives, `StatusCode`, container types, address/identity types.
- [Namespaces in o6\\Python](namespace/namespace-mapping-in-o6.md) — How o6\\Python abstracts from manual namespace managing
- [Writing a Nodeset in Python](namespace/writing-nodesets-in-python.md) — Declaring datatypes, enums, VariableTypes and ObjectTypes without any XML
- [Implementing Object Behavior](namespace/implementing-object-behavior.md) — The implement pattern: Method calls and Variable read/write behind a declared type
